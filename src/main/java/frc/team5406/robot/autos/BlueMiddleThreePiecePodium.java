...
public class BlueMiddleThreePiecePodium extends SequentialCommandGroup {
  /** Creates a new Leave. */
  ...
  public BlueMiddleThreePiecePodium(DriveSubsystem drive, ArmSubsystem arm, ShooterSubsystem shooter, FeederSubsystem feeder, VisionSubsystem camera, IntakeSubsystem intake, Supplier<AprilTag> targetSupplier) {
    this.arm = arm;
