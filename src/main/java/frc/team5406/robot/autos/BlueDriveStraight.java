...
public class BlueDriveStraight extends SequentialCommandGroup {
  /** Creates a new Leave. */
  final DriveSubsystem drive;
  public BlueDriveStraight(DriveSubsystem driveSubsystem) {
    ...
    addCommands(
      new InstantCommand(() -> drive.resetPose(new Pose2d(new Translation2d(0.0, 0.0), Rotation2d.fromDegrees(0.0)))),
      new WaitCommand(3),
      auto.getCommand()
    );
  }
