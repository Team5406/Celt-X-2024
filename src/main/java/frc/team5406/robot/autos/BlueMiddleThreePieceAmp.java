...
public class BlueMiddleThreePieceAmp extends SequentialCommandGroup {
  /** Creates a new Leave. */
  ...
  public BlueMiddleThreePieceAmp(DriveSubsystem drive, ArmSubsystem arm, ShooterSubsystem shooter, FeederSubsystem feeder, VisionSubsystem camera, IntakeSubsystem intake, Supplier<AprilTag> targetSupplier) {
    this.arm = arm;
    ...
    List<Pose2d> path2 = List.of(
      new Pose2d(new Translation2d(2.6, 5.55), Rotation2d.fromDegrees(0.0)),
      new Pose2d(new Translation2d(2.3, 6.5), Rotation2d.fromDegrees(20)),
      new Pose2d(new Translation2d(2.6, 6.8), Rotation2d.fromDegrees(20))
    );
