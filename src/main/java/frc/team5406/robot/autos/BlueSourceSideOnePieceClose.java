...
public class BlueSourceSideOnePieceClose extends SequentialCommandGroup {
  /** Creates a new Leave. */
  ...
  public BlueSourceSideOnePieceClose(DriveSubsystem drive, ArmSubsystem arm, ShooterSubsystem shooter, FeederSubsystem feeder) {
    this.arm = arm;
