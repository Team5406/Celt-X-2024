...
public class RedAmpSideTwoPieceClose extends SequentialCommandGroup {
  /** Creates a new Leave. */
  ...
  public RedAmpSideTwoPieceClose(DriveSubsystem drive, ArmSubsystem arm, ShooterSubsystem shooter, FeederSubsystem feeder, VisionSubsystem camera, IntakeSubsystem intake, Supplier<AprilTag> targetSupplier) {
    this.arm = arm;
