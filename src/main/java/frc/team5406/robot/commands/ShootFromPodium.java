...
public class ShootFromPodium extends Command {
  ...
  public void initialize(){
    if (backwards){
      arm.gotoArmAngle(Constants.PodiumSettings.PODIUM_ARM_ANGLE_BACKWARDS);
      shooter.setShooterSpeed(Constants.PodiumSettings.PODIUM_SET_SPEED);
    }else {
      arm.gotoArmAngle(Constants.PodiumSettings.PODIUM_ARM_ANGLE);
      shooter.setShooterSpeed(Constants.PodiumSettings.PODIUM_SET_SPEED);
    }
  }
