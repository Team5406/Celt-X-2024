...
public class RedMiddleTwoPieceClose extends SequentialCommandGroup {
  /** Creates a new Leave. */
  ...
  public RedMiddleTwoPieceClose(DriveSubsystem drive, ArmSubsystem arm, ShooterSubsystem shooter, FeederSubsystem feeder, VisionSubsystem camera, IntakeSubsystem intake, Supplier<AprilTag> targetSupplier) {
    this.arm = arm;
